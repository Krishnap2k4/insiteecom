...
import { ADMIN_BRAND_ADD, ADMIN_BRAND_SHOW, ADMIN_CAMPAIGN_ADD, ADMIN_CAMPAIGN_SHOW, ADMIN_CATEGORY_ADD, ADMIN_CATEGORY_SHOW, ADMIN_CONTACTS_SHOW, ADMIN_COUPON_ADD, ADMIN_COUPON_SHOW, ADMIN_CUSTOMERS_SHOW, ADMIN_CUSTOMER_GROUPS_ADD, ADMIN_CUSTOMER_GROUPS_SHOW, ADMIN_DASHBOARD, ADMIN_EMAIL_TEMPLATES_SHOW, ADMIN_INVENTORY_SHOW, ADMIN_MAINTENANCE_SHOW, ADMIN_MEDIA_SHOW, ADMIN_NEWSLETTER_SHOW, ADMIN_ORDER_SHOW, ADMIN_PRODUCT_ADD, ADMIN_PRODUCT_SHOW, ADMIN_REFUND_SHOW, ADMIN_RETURN_SHOW, ADMIN_REVIEW_SHOW, ADMIN_ROLES_SHOW, ADMIN_SHIPMENT_SHOW, ADMIN_SHOP_THE_LOOK_ADD, ADMIN_SHOP_THE_LOOK_SHOW, ADMIN_SUPPORT_SHOW } from "@/routes/AdminPanelRoute";
...
export const adminAppSidebarMenu = [
    ...
    {
        // Content group — will grow into the CMS when Module 7 ships.
        // Add CMS pages (pages, menus, settings) here later.
        title: "Content",
        url: "#",
