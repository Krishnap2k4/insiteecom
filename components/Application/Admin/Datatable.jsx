    ...
    const table = useMaterialReactTable({
        ...
        renderToolbarInternalActions: ({ table }) => (
            <>
                ...
                {/* Trash + bulk-delete only render when the parent
                    actually wired them up. A read-only datatable
                    (e.g. returns / refunds / shipments) leaves
                    `trashView` and `deleteEndpoint` unset and gets
                    neither button. */}
        ...
        // Export is opt-in — only render the button when the parent
        // wired up an `exportEndpoint`. Otherwise pressing it would
        // hit `undefined` and toast a confusing error.
        renderTopToolbarCustomActions: exportEndpoint
            ? ({ table }) => (
                <Tooltip>
                    <ButtonLoading
                        type="button"
