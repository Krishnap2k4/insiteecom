    ...
    return (
        <div>
            ...
            <div className='lg:px-40 px-5 py-20 text-white/70'>
                ...
                <p>Welcome to ELOIR. By accessing or using our website, you agree to be bound by the following terms and conditions. Please read them carefully.</p>
                ...
                <ul className='list-disc ps-10 mt-3 space-y-2'>
                    <li>All content on ELOIR, including logos, images, and text, is the property of ELOIR and protected by copyright laws.</li>
                ...
                <p className='mt-3'>
                    Thank you for choosing ELOIR. We value your trust and are committed to delivering a secure and reliable shopping experience.
                </p>
            </div>
        </div>
    )
