    ...
    return (
        <div>
            ...
            <div className='lg:px-40 px-5 py-20 text-white/70'>
                ...
                <p className='mt-8 font-semibold text-white/90'>Information We Collect:</p>
                <ul className='list-disc ps-10 mt-3 space-y-2'>
                    <li><b className='text-white'>Personal Information:</b> Such as your name, email address, phone number, and shipping/billing addresses, provided during account registration or checkout.</li>
                    <li><b className='text-white'>Payment Details:</b> Collected securely through encrypted payment gateways.</li>
                    <li><b className='text-white'>Usage Data:</b> Including your browser type, IP address, pages visited, and time spent on the site to help us improve user experience.</li>
                </ul>

                <p className='mt-8 font-semibold text-white/90'>How We Use Your Information:</p>
                <ul className='list-disc ps-10 mt-3 space-y-2'>
