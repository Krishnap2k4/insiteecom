...
const breadcrumbData = [
    ...
    { href: ADMIN_SHIPMENT_SHOW, label: 'Shipments' },
]

const ShowShipments = () => {
    const columns = useMemo(() => columnConfig(DT_SHIPMENT_COLUMN), [])
            ...
            <Card className='py-0 rounded shadow-sm gap-0'>
                <CardHeader className='pt-3 px-3 border-b [.border-b]:pb-2'>
                    <div className='flex justify-between items-center'>
                        <h4 className='text-xl font-semibold'>Shipments</h4>
                    </div>
                </CardHeader>
                <CardContent className='px-0 pt-0'>
                    <DatatableWrapper
                        queryKey='shipments-data'
                        fetchUrl='/api/admin/shipments'
                        initialPageSize={10}
